...
// Export uniquement les composants nommés pour éviter les confusions d'importation
...
export const WavyLine = ({ className }) => {
  return (
    <svg className={className} width="100%" height="20" viewBox="0 0 1000 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
// Supprimé l'export par défaut pour éviter les confusions
// Maintenant on utilisera toujours les imports nommés